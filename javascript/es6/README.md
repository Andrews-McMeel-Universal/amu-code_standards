...
| `amuGame.event.type`               | string (required)           | The event name, available options are: `"start"`, `"pause"`, `"resume"`, `"end"`, `"replay"`, `"print"`, `"help"`, `"change mode"`, `"change settings"`, `"spot difference"`, `"solve word"`                                                                                                                                                                                                              |
