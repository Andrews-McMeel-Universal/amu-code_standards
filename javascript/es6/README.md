...
| `loadSettings`                      | object                              | Sends settings data for customizing game behavior. This is consistent for all games and will be a copy of what is received in `amuGame.event.details`. If available, `loadSettings` data is sent at the same time as `initGame`. If no `loadSettings` data is sent, the game is expected to load default settings.                                                                                                              |
| `loadSettings.autoNotes`            | boolean (required)                  | Whether or not auto notes is enabled. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                                                                    |
| `loadSettings.darkMode`             | boolean (required)                  | Whether or not dark mode is enabled. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                                                                     |
| `loadSettings.jumpToFirstEmpty`     | boolean (required)                  | When at the end of a word, whether or not to jump to the first blank cell. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                               |
| `loadSettings.jumpToNextClue`       | boolean (required)                  | When at the end of a word, whether or not to jump to the next clue. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                                      |
| `loadSettings.showRelated`          | boolean (required)                  | Whether or not highlighting related cells is enabled. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                                                    |
| `loadSettings.skipFilled`           | boolean (required)                  | When within a word, whether or not to skip filled squares. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                                               |
| `loadSettings.sound`                | boolean (required)                  | Whether or not sound is enabled. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                                                                         |
| `loadSettings.visualTimer`          | boolean (required)                  | Whether or not a visual timer is enabled. If this setting is not available in a game, then the value is `false`.                                                                                                                                                                                                                                                                                                                |
| `loadState`                         | object                              | Sends state data that represents a replicable moment during a user's game session. This varies per game and will be a copy of what is received in `amuGame.state`. If available, `loadState` data is sent at the same time as `loadLevel`. If no `loadState` data is sent, the game is expected to start new session.                                                                                                           |
...
| `amuGame.event.type`                   | string (required)            | The event name, available options are: `"start"`, `"pause"`, `"resume"`, `"end"`, `"replay"`, `"print"`, `"help"`, `"change mode"`, `"change settings"`, `"spot difference"`, `"solve word"`, `"onboarding complete"`                                                                                                                                                                                     |
...
| `amuGame.event.details`                | object or string (required)  | If applicable, additional details about the event. If the `amuGame.event.type` is `"change settings"` _and_ a setting defined above in `loadSettings` was changed, then the current and complete settings object should be sent in `amuGame.event.details`, otherwise a string describing the event is expected.                                                                                          |
...
| `amuGame.state.clearedBoard`           | boolean (required)           | `true` if the user cleared the game board. This action is comparable to the user deleting all answers they submitted, and it does not reset the game timer, statistics like mistakes or hints, or game settings. See `amuGame.state.resetLevel` for when a user completely resets the level to its starting state.                                                                                        |
...
| `amuGame.state.resetLevel`             | boolean (required)           | `true` if the user reset the game level state, such as when choosing to replay the level after completing it. This action sets everything except for `resetLevel` and game settings back to initial values, including the game timer, statistics like mistakes made or whether hints were used, and any other level progress. See `amuGame.state.clearedBoard` for when a user deletes submitted answers. |
| `amuGame.state.totalPlayTime`          | number (required)            | Milliseconds since game start, excluding paused time.                                                                                                                                                                                                                                                                                                                                                     |
| `amuGame.state.score`                  | object (required)            | The user's current score, whether that be points or a time.                                                                                                                                                                                                                                                                                                                                               |
| `amuGame.state.score.value`            | integer or string (required) | The total points earned when the game is completed. If the game doesn't use numerical points, it should return the score as a string. For instance, if scores are time-based, it should be formatted like `"HH:mm:ss.sss"`.                                                                                                                                                                               |
| `amuGame.state.score.formattedScore`   | string                       | The score exactly as displayed to the user. For instance, if they completed the game and are shown that their score is "0.2s" then this value should be `"0.2s"`. If the final score hasn't been calculated yet, then this value can be omitted.                                                                                                                                                          |
| `amuGame.state.totalScore`             | number or string (required)  | DEPRECATED, see `amuGame.state.score`.                                                                                                                                                                                                                                                                                                                                                                    |
...
| `amuGame.state.lettersGuessed`         | array containing strings     | The letters used in "guessing" mode, in the order they are entered by the user.                                                                                                                                                                                                                                                                                                                           |
...
| `amuGame.state.solvedLevelWithGuesses` | boolean                      | `true` if the user solved the level using only "guesses".                                                                                                                                                                                                                                                                                                                                                 |
| `amuGame.state.solvedThemeWithGuesses` | boolean                      | `true` if the user solved the theme word using only "guesses".                                                                                                                                                                                                                                                                                                                                            |
| `amuGame.state.usedHints`              | boolean                      | `true` if the user used hint functionality.                                                                                                                                                                                                                                                                                                                                                               |
| `amuGame.state.usedUndo`               | boolean                      | `true` if the user used undo functionality.                                                                                                                                                                                                                                                                                                                                                               |
...
let message = {
  amuGame: {
    ...
    state: {
      ...
      solvedLevelWithGuesses: false,
      solvedThemeWithGuesses: false,
      usedHints: false,
      usedUndo: false,
      wordsSolved: 3,
    },
...
- `"change settings"`, when the user updates the in-game settings, such as to disable/enable sound. See `loadSettings` above for more information about what options are expected in the `amuGame.event.details` of this event, if they are applicable.
- `"spot difference"`, when the user successfully finds a difference.
- `"solve word"`, when the user successfully solves a word.
- `"onboarding complete"`, when the user finishes the in-game onboarding or first time user experience. This should not trigger when onboarding is skipped, only when it is fully completed.
