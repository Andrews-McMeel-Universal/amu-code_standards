...
| `loadSettings`                      | object                              | Sends settings data for customizing game behavior. This is consistent for all games and will be a copy of what is received in `amuGame.event.details`. If available, `loadSettings` data is sent with `loadConfig`. If no `loadSettings` data is sent with `loadConfig`, the game is expected to load default settings.                                                                                                         |
